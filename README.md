...
**You need Python on your local machine and a way to execute Python files** (whether that be via extensions in VS Code or another method). 
There are two test cases to demonstrate the program's execution options. 
